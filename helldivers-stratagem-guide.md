...
## Great on bugs only:
> Some might be playable on bots if you end up with it by accident. Don't take it on purpose though. <br>
...
## Great on bots only:
> Some might be playable on bugs if you end up with it by accident. Don't take it on purpose though. <br>
